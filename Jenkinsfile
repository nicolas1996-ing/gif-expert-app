          ...
          steps {
            script {
              try {
                sh '''
                  mkdir -p chrome-test
                  cp -r node_modules src public jest.config.js jest.setup.js package.json package-lock.json chrome-test/
                  cd chrome-test
            ...
            script {
              try {
                sh '''
                  ...
                  cp -r node_modules src public jest.config.js jest.setup.js package.json package-lock.json firefox-test/
                  cd firefox-test
